...
public class CCClogSpamHiderPlugin extends Plugin
{
	...
	private final ArrayList<String> beginnerClueItems = new ArrayList<>(Arrays.asList("Mole slippers", "Frog slippers", "Bear feet", "Demon feet", "Jester cape", "Shoulder parrot", "Monk's robe top (t)", "Monk's robe (t)", "Sandwich lady", "Rune scimitar ornament kit", "Black pickaxe", "Amulet of defence (t)"));
	...
	private final ArrayList<String> forestryItems = new ArrayList<>(Arrays.asList("Fox whistle", "Forestry", "Lumberjack", "Twitcher's gloves", "Funky shaped log", "Log basket", "Log brace", "Clothes pouch", "Cape pouch", "Felling axe handle", "Pheasant", "pheasant", "Petal garland", "beehive parts"));
